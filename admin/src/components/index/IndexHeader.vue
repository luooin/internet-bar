	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#000","headFontSize":"20px","headUserInfoFontColor":"#000","headBoxShadow":"0 1px 6px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(255, 255, 255, 0.45)","headFontColor":"#000","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#000","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
		...
		mounted() {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					// this.$storage.set('userid',data.data.id);
					console.log("this.$storage.get('userid')",this.$storage.get('userid'));
				} else {
