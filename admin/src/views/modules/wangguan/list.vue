    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '网管账号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
              v-model="searchForm.wangguanzhanghao" placeholder="网管账号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
              v-model="searchForm.wangguanzhanghao" placeholder="网管账号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.wangguanzhanghao" placeholder="网管账号"
              clearable></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '网管姓名' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
              v-model="searchForm.wangguanxingming" placeholder="网管姓名" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
              v-model="searchForm.wangguanxingming" placeholder="网管姓名" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.wangguanxingming" placeholder="网管姓名"
              clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <el-button v-if="isAuth('wangguan', '新增') && contents.btnAdAllIcon == 0" type="success"
            ...
            <el-button v-if="isAuth('wangguan', '删除') && contents.btnAdAllIcon == 0 && contents.tableSelection"
              :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">{{ contents.btnAdAllFont
                == 1 ? '删除' : '' }}</el-button>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          v-if="isAuth('wangguan', '查看')" :data="dataList" v-loading="dataListLoading"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="wangguanzhanghao"
            :header-align="contents.tableAlign" label="网管账号">
            <template slot-scope="scope">
              {{ scope.row.wangguanzhanghao }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="wangguanxingming"
            :header-align="contents.tableAlign" label="网管姓名">
            <template slot-scope="scope">
              {{ scope.row.wangguanxingming }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="beizhu"
            :header-align="contents.tableAlign" label="备注">
            <template slot-scope="scope">
              {{ scope.row.beizhu }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="lianxidianhua"
            :header-align="contents.tableAlign" label="联系电话">
            <template slot-scope="scope">
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="chushengnianyue"
            :header-align="contents.tableAlign" label="出生年月">
            <template slot-scope="scope">
          ...
          <el-table-column width="300" :align="contents.tableAlign" :header-align="contents.tableAlign" label="操作">
            <template slot-scope="scope">
              <el-button
                v-if="isAuth('wangguan', '查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
              ...
              <el-button
                v-if="isAuth('wangguan', '查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('wangguan', '查看') && contents.tableBtnIcon == 0" type="success" size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')">{{ contents.tableBtnFont == 1 ? '详情' : ''
                }}</el-button>
              <el-button
                v-if="isAuth('wangguan', '修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">{{
                  contents.tableBtnFont == 1 ? '修改' : '' }}</el-button>
              <el-button
                v-if="isAuth('wangguan', '修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('wangguan', '修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
              ...
              <el-button
                v-if="isAuth('wangguan', '删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">{{
                  contents.tableBtnFont == 1 ? '删除' : '' }}</el-button>
              <el-button
                v-if="isAuth('wangguan', '删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('wangguan', '删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
    ...
    return {
      ...
      contents: {
        ...
        "box": {
          ...
          "flag": "1",
          "backgroundImage": "http://codegen.caihongy.cn/20211129/c8435b339fdb471986c219f0736bbc03.png",
          "background": "#fff"
        },
        "inputBorderWidth": "5px 2px",
        "inputFontPosition": "1",
        "inputFontColor": "#ff8b1e",
        "pageEachNum": 10,
        "tableHeaderBgColor": "#ff8b1e",
        "inputTitleColor": "#ff8b1e",
        ...
        "inputBgColor": "rgba(255, 255, 255, 0.77)",
        "pageStyle": false,
        "pageTotal": true,
