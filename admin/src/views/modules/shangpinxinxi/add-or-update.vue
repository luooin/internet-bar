<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品详情" prop="shangpinxiangqing">
          <el-input v-model="ruleForm.shangpinxiangqing" 
              placeholder="商品详情" clearable  :readonly="ro.shangpinxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品详情" prop="shangpinxiangqing">
              <el-input v-model="ruleForm.shangpinxiangqing" 
                placeholder="商品详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
